/**
 * Day 11 - Markdown-Aware Text Splitting
 * Python equivalent: markdown_splitting.py
 *
 * RecursiveCharacterTextSplitter.from_language(Language.MARKDOWN)
 * In JS: MarkdownTextSplitter — splits at Markdown headers first.
 */
...
// Markdown splitter — respects header hierarchy
